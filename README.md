...
1. Build a binary of the application
...
3. Run the application by executing the binary

    `make run`

4. Publish the application image to quay.io

    `make publish`

5. Deploy the application to an OCP cluster
